...
export const streamListReducer = (
  ...
  switch (action.type) {
    ...
    case CREATE_COMMENT_SUCCESS:
      ...
      state.streams[action.payload.index].loadingCreateComment = false;
      state.streams[a] = action.payload.data.updatedStream;
      return {
        ...state,
        /*
        streams: {
          comments: [action.payload.data.comments, ...state.streams.comments],
        },*/
      };
      ...
      return {
        ...
        streams: [
          ...state.streams.slice(0, action.payload.index),
          {
            ...
            loadingCreateComment: false,
            errorCreateCommente: action.payload.error,
          },
